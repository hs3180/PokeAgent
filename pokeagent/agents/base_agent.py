...
class BaseAgent(Player):
    ...
    def get_battle_state(self, battle: Battle) -> Dict[str, Any]:
        ...
        return {
            ...
            'opponent_active_pokemon': battle.opponent_active_pokemon.species if battle.opponent_active_pokemon else None,
    ...
    def get_win_probability(self, battle: Battle) -> float:
        ...
        opponent_remaining = len([p for p in battle.opponent_team.values() if p.fainted is False])
